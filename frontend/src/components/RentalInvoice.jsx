...
const RentalInvoice = () => {
  ...
  useEffect(() => {
    ...
    /* Freelancer */
    ctx.font = "22px Arial";
    ctx.fillText(freelancer.name || "Owner name", 40, 50);
    ...
    let y = 320;
    ctx.font = "16px Arial";
    ctx.fillText("Building type", 40, y);
    ctx.fillText("Description", 220, y);
    ctx.fillText("rooms", 520, y);
    ctx.fillText("Rent", 600, y);
    ctx.fillText("tax", 700, y);
      ...
      <div className="h-full bg-white rounded-xl shadow-lg grid lg:grid-cols-2 gap-6 p-4">
        ...
        <div className="h-full overflow-y-auto pr-2 space-y-6">
          ...
          <Section title="Customer Information">
           ...
           <Section title="Building,Description,rooms,rent">
